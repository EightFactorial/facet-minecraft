...
pub trait Deserializer {
    ...
    fn deserialize_unit<'input>(
        &mut self,
        input: &'input [u8],
    ) -> Result<((), &'input [u8]), DeserializeError<'input, '_, '_>>;

    /// Deserialize an unsigned 8-bit integer.
    fn deserialize_u8<'input>(
        &mut self,
        input: &'input [u8],
    ) -> Result<(u8, &'input [u8]), DeserializeError<'input, '_, '_>>;
    ...
    fn deserialize_usize<'input>(
        &mut self,
        input: &'input [u8],
    ) -> Result<(usize, &'input [u8]), DeserializeError<'input, '_, '_>> {
    ...
    fn deserialize_isize<'input>(
        &mut self,
        input: &'input [u8],
    ) -> Result<(isize, &'input [u8]), DeserializeError<'input, '_, '_>> {
    ...
    fn deserialize_f32<'input>(
        &mut self,
        input: &'input [u8],
    ) -> Result<(f32, &'input [u8]), DeserializeError<'input, '_, '_>>;

    /// Deserialize a double-precision floating-point value.
    fn deserialize_f64<'input>(
        &mut self,
        input: &'input [u8],
    ) -> Result<(f64, &'input [u8]), DeserializeError<'input, '_, '_>>;
    ...
    fn deserialize_str<'input>(
        &mut self,
        input: &'input [u8],
    ) -> Result<(&'input str, &'input [u8]), DeserializeError<'input, '_, '_>>;
}
